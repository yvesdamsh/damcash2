    ...
    return (
        <>
            <Popover open={isOpen} onOpenChange={setIsOpen}>
                ...
                <PopoverContent className="w-64 p-2 border-[#4a3728] bg-[#fdfbf7]" align="end">
                    <div className="space-y-2">
                        <div className="px-2 py-1.5 text-sm font-semibold text-[#4a3728] border-b border-[#d4c5b0] mb-2">
                            Paramètres
                        </div>
                        
                        <div className="space-y-1">
                            <p className="px-2 text-xs text-gray-500 uppercase font-bold">Thème</p>
                            <div className="grid grid-cols-3 gap-1 px-2">
                                <Button 
                                    variant={currentTheme === 'light' ? "default" : "outline"} 
                                    size="sm" 
                                    className={`h-8 ${currentTheme === 'light' ? "bg-[#4a3728]" : "border-[#d4c5b0]"}`}
                                ...
                                <Button 
                                    ...
                                    size="sm" 
                                    className={`h-8 ${currentTheme === 'dark' ? "bg-[#4a3728]" : "border-[#d4c5b0]"}`}
                                ...
                                <Button 
                                    ...
                                    size="sm" 
                                    className={`h-8 ${currentTheme === 'system' ? "bg-[#4a3728]" : "border-[#d4c5b0]"}`}
                        ...
                        <div className="border-t border-[#d4c5b0] my-2" />
