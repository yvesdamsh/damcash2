...
export default function CheckerPiece({ type, isSelected, animateFrom, design = 'standard', onDragStart, onDragEnd }) {
    ...
    return (
        <motion.div
            ...
            className={`relative w-[85%] h-[85%] m-auto rounded-full z-10 ${isSelected ? 'cursor-grab' : 'cursor-grab'}`}
        >
            <div 
                className={`
