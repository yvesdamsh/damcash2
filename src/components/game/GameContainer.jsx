...
export default function GameContainer() {
    ...
    useEffect(() => {
        ...
        const aiColor = game.current_turn;
        if (isAiTurn) {
            const delay = id === 'local-ai' ? 350 : 700;
            const makeAiMove = async () => {
                ...
                try {
                    ...
                    if ((!res || !res.data || res?.data?.error || !res.data.move) && game.game_type === 'checkers') {
                      const all = getCheckersValidMoves(board, aiColor);
    ...
    const handleAcceptTakeback = async () => {
        ...
        try {
            ...
            if (newMoves.length > 0) {
                ...
                prevBoardState = lastMoveData.board;
